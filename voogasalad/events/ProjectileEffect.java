...
public class ProjectileEffect extends SpawnEffect {
    ...
    public ProjectileEffect (String archetype,
                             Double xPos,
                             Double yPos,
                             Double xVelocity,
                             Double yVelocity,
    ...
    public void execute (ILevelData data) {
        ...
        if (myVelocityScale != null) {
            myVelocity =
                    new Velocity(data.getSpriteByID(myShooterID).getVelocity().getX() *
                                 myVelocityScale,
                                 data.getSpriteByID(myShooterID).getVelocity().getY() *
                                                  myVelocityScale);
        }
