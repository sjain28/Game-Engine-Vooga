...
public class CauseAndEffectFactory {
    ...
    /**
     * Takes in a string stating what kind of cause/effect is being made as well as all of its
     * parameters. Also takes in the
     * event to which the cause/effect is being added. Parses the string to get the information for
     * the cause/effect and uses
     ...
     * @param inputString A comma-separated String representing all user input to instantiate a
     *        Cause or Effect
     */
    public void create (VoogaEvent event,
                        String inputString) throws VoogaException, ClassNotFoundException,
    ...
    private void initConstructorParams (String[] parameters,
                                        Class<?>[] paramClasses,
                                        Object[] allParams,
                                        VoogaEvent event) {
    ...
    /**
     * Parses the input string from the user stating conditions for cause/effect in order to use as
