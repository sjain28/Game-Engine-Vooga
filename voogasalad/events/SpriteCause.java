...
public class SpriteCause extends VariableCause {
     ...
     * @param varName
     * @param predicate
     * @param target A target value for testing equality or other logical relationships to the
     *        Sprite property
     * @param voogaEvent
     */
    public SpriteCause (String spriteID,
                        String varName,
                        String predicate,
                        Double target,
    ...
    /**
     * Separate constructor to take a String instead of a Boolean or Double. Needed for Reflection
     * in factory.
     * 
     * @param spriteID
     * @param varName
    ...
    public String toString () {
        return "Checking if the variable " + myVarName + " in Sprite " + mySpriteID +
               " is equal to " + super.getTarget();
    }
}
