...
public class CollisionPlayground2 extends Application {
    ...
    private static final double SCENE_SIZE_X = 800;
    private static final double SCENE_SIZE_Y = 600;
    ...
    public void start(Stage primaryStage) {
        ...
        createBalls(NUM_BALLS, MIN_RADIUS, MAX_RADIUS, MIN_SPEED, MAX_SPEED, SCENE_SIZE_X/2, SCENE_SIZE_Y/2);
        ...
        final Scene scene = new Scene(root, SCENE_SIZE_X, SCENE_SIZE_Y);
    ...
    private static class Ball {
        ...
        public void setCollisionCount(Integer newCount){
    ...
    private static class FrameStats {
        ...
        public String toString() {
            return String.format("Frame count: %,d Average frame interval: %.3f milliseconds Collision Count: %,d", getFrameCount(), getMeanFrameInterval(), collisionCount);
        }
    }
