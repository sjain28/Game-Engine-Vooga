...
public class Sprite implements Moveable, Effectable, Elementable {
    ...
    private void reloadDimensions () {
        ...
        Bindings.bindBidirectional(myProperties.get(WIDTH).getProperty(),
                                   myImage.fitWidthProperty());
        Bindings.bindBidirectional(myProperties.get(HEIGHT).getProperty(),
    ...
    private void initializeCoordinates () {
        myProperties.put(XPOS, new VoogaNumber());
        myProperties.put(YPOS, new VoogaNumber());
        myProperties.put(ZPOS, new VoogaNumber());
        reloadCoordinates();
    }
    ...
    private void reloadCoordinates () {
        ...
        Bindings.bindBidirectional(myX, myProperties.get(XPOS).getProperty());
        Bindings.bindBidirectional(myY, myProperties.get(YPOS).getProperty());
        Bindings.bindBidirectional(myZ, myProperties.get(ZPOS).getProperty());
    ...
    public String getImagePath () {
        return myProperties.get(IMAGE_PATH).getValue()
                .toString();
    }
    ...
    public void setHeight (Double height) {
        myProperties.get(HEIGHT).setValue(height);
        myImage.setFitHeight(height);
    }

    public void setWidth (Double width) {
        myProperties.get(WIDTH).setValue(width);
