...
public class GenericPropertiesTab extends Tab {
	...
	public void createButtons () {
		Button addProperty =
				new ButtonMaker().makeButton(ppProperties.getString("Add"), e -> addNewPropertyPrompt());
		Button apply = new ButtonMaker().makeButton(ppProperties.getString("Apply"), e -> updateProperties());
