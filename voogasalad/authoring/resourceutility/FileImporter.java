...
/**
 * This class prompts the user to choose a file to import. The accepted extensions can
 * be found in the properties file "extensions.properties"
 * @author DoovalSalad
 */
...
public class FileImporter {
	...
	/**
	 * The constructor that initializes the file chooser and calls to add to UI upon choosing
	 * a file.
	 * @param ui
	 */
	 ...
	 * there. Note that this implementation allows multiple copies of the same file
	 * to exist given that they are named differently.
	 */
