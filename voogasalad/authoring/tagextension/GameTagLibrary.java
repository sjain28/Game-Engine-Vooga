...
public class GameTagLibrary {
     ...
     * 
     * @return list of pair between the game name and the tag it can be searched by
     */
        ...
        for (File child : directoryListing) {
            ...
            if (ext.equals(TAG_SUFFIX)) {
                ...
                try {
                    String gamename =
                            child.getName()
                                    .substring(0, child.getName().length() - TAG_SUFFIX.length());
                    List<Object> objects =
                            Deserializer.deserialize(1, dir.getName() + "/" + child.getName());
