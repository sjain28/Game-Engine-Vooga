...
public class CreateCommand implements Command {
	...
	@Override
	public void execute() {
		ProjectChooseAuthoringTypePrompt authoringTypePrompt = new ProjectChooseAuthoringTypePrompt();
	...
	private void showNewGamePrompt() {
		...
		newGamePrompt.setProceedEvent(ee -> {
			...
			String description = getFieldOrDefault(newGamePrompt.getDescription(), DEFAULT_DESCRIPTION);
