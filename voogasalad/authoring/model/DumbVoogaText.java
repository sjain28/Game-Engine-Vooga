...
public class DumbVoogaText extends TextField implements Elementable {

    Map<String, VoogaData> myProperties = new HashMap<String, VoogaData>();
    String myID;

    public DumbVoogaText () {
        init();
    }

    // stroke, color, font, text, size, name/group, position (x,y,z),
    public DumbVoogaText (double x, double y, String text) {
        init();
    ...
    public DumbVoogaText (String text) {
        this(0, 0, text);
    }
