...
public class PropertiesWindow extends TabPane implements Windowable {
	...
	public void createButtons() {
		...
		propertiesPane.getChildren().add(addProperty);
		...
		propertiesPane.getChildren().add(buttonsPanel);
	}
