...
public class LevelTransitioner {
    ...
    private EventManager myKeyEventContainer;
     ...
     * @param nextlevelkey
     */
    public LevelTransitioner(String levelfilename, Map<String, Elementable> elements, EventManager container, 
