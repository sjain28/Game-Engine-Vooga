...
/**
 * Modified version of general screen capture tester to capture a single 
 * frame of wherever is called on.
 * 
...
public class ScreenshotEncoder {
    //TODO given player size, location, and whether we want a snapshot or video
    ...
    public ScreenshotEncoder(int screenShotCount, Rectangle frameLocation) {
